...
apk add git cmake xorg-server cairo-dev dbus dbus-libs gobject-introspection-dev py3-dbus-dev librsvg-dev gtk+3.0 terminus-font ttf-inconsolata ttf-dejavu font-noto font-noto-cjk ttf-font-awesome font-noto-extra font-isas-misc

echo -e "${COL}Downloading KlipperScreen\n${NC}"
git clone --depth 1 https://gitee.com/Neko-vecter/KlipperScreen.git /KlipperScreen
echo -e "${COL}Setting up KlipperScreen\n${NC}"
